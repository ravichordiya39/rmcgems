	...
	<div class="row-fluid">
		...
		<div id="content" class="span10">
			...
			if($_FILES['image']['name'] != ""){
					...
					$res = $functions->addRmcLeftInfrastructure();
			...
			if($rmc_story_left == ''){
					...
					$res = $functions->addRmcRightInfrastructure($rmc_story_left);
						...
						<fieldset>
                        	<div class="control-group span12" style="margin-left: 0px;">
							  <label class="control-labe1l" style="margin-bottom: 15px"><strong>Rmc Story right section</strong></label>
							   ...
							   <textarea name="editor1"><?php echo $res[0]['rmc_infra_right'];  ?></textarea>
						...
						<fieldset>
                        	<div class="control-group span12" style="margin-left: 0px;">
                         	...
                         	<div class="control-group span12" style="margin-left: 0px;">
							  ...
							  <div style="font-size:10px">Image dimension : 916X650</div>	
							</div>
