	...
	<div class="row-fluid">
		...
		<div id="content" class="span10">
			...
			if($_FILES['image']['name'] != ""){
					...
					$res = $functions->addRmcAwardsBanner();
					...
					<form class=""  method="post" enctype="multipart/form-data">
						<fieldset>
                        	<div class="control-group span12" style="margin-left: 0px;">
							  <label class="control-labe1l" style="margin-bottom: 15px"><strong>Rmc Awards Banner Section</strong></label>
