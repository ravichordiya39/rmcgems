	...
	<div class="row-fluid">
		...
		<div id="content" class="span10">
            <ul class="breadcrumb">
				...
				<li><a href="#">Rmc Gemstone Page</a></li>
			</ul>
						<?php 
			...
			if(@$_REQUEST['action']=='remove'){
				$res = $functions->rmcGemstoneSecondSectionRemoveCotent($id);
				if($res){
			...
			header('Location: rmc-gemstone-page');
			exit();
				}	
			}
			
			if(@$_REQUEST['action']=='remove1'){
				$res = $functions->rmcGemstoneThirdSectionRemoveCotent($id);
				if($res){
			...
			if(@$_REQUEST['action']=='remove2'){
				$res = $functions->rmcGemstoneFourthSectionRemoveCotent($id);
				if($res){
			...
			if(@$_REQUEST['action']=='remove3'){
				$res = $functions->rmcGemstoneFifthSectionRemoveCotent($id);
				if($res){
			...
			if(@$_REQUEST['action']=='remove4'){
				$res = $functions->rmcGemstoneSixthSectionRemoveCotent($id);
				if($res){
			...
			if($_FILES['image']['name'] != ""){
					...
					$res = $functions->addGemstoneFirstSection($image);
			...
			if(@$_POST['submit'] == 'Upload'){
				...
				if($_FILES['image']['name'] != ""){
						...
						$res = $functions->addGemstoneSecondSection($content,$image);
			...
			if(@$_POST['submit'] == 'Upload1'){
				...
				if($_FILES['image']['name'] != ""){
						...
						$res = $functions->addGemstoneThirdSection($content,$image);
			...
			if(@$_POST['submit'] == 'Upload2'){
				...
				if($_FILES['image']['name'] != ""){
						...
						$res = $functions->addGemstoneFourthSection($content,$image);
			...
			if(@$_POST['submit'] == 'Upload3'){
				...
				if($_FILES['image']['name'] != ""){
						...
						$res = $functions->addGemstoneFifthSection($content,$image);
			...
			if(@$_POST['submit'] == 'Upload4'){
				...
				if($_FILES['image']['name'] != ""){
						...
						$res = $functions->addGemstoneSixthSection($content,$image);
					...
					$res = $functions->get('gemstone_sections');
			?>
			...
			<div class="row-fluid">		
				<div class="span12">
					...
					<form class=""  method="post" enctype="multipart/form-data">
						<fieldset>
                        	<div class="control-group span12" style="margin-left: 0px;">
							  <label class="control-labe1l" style="margin-bottom: 15px; "><strong>Rmc Gemstone Banner Section</strong></label>
					...
					<form class=""  method="post" enctype="multipart/form-data">
						<fieldset>
							<div class="control-group span12" style="margin-left: 0px;">
							  <label class="control-labe1l" style="margin-bottom: 15px; "><strong>Rmc Gemstone Second Section</strong></label>
					...
					<form class=""  method="post" enctype="multipart/form-data">
						<fieldset>
							<div class="control-group span12" style="margin-left: 0px;">
							  <label class="control-labe1l" style="margin-bottom: 15px; "><strong>Rmc Gemstone Third Section</strong></label>
					...
					<form class=""  method="post" enctype="multipart/form-data">
						<fieldset>
							<div class="control-group span12" style="margin-left: 0px;">
							  <label class="control-labe1l" style="margin-bottom: 15px; "><strong>Rmc Gemstone Fourth Section</strong></label>
					...
					<form class=""  method="post" enctype="multipart/form-data">
						<fieldset>
							<div class="control-group span12" style="margin-left: 0px;">
							  <label class="control-labe1l" style="margin-bottom: 15px; "><strong>Rmc Gemstone Fifth Section</strong></label>
					...
					<form class=""  method="post" enctype="multipart/form-data">
						<fieldset>
							<div class="control-group span12" style="margin-left: 0px;">
							  <label class="control-labe1l" style="margin-bottom: 15px; "><strong>Rmc Gemstone Sixth Section</strong></label>
