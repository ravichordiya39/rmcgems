	...
	<div class="row-fluid">
		...
		<div id="content" class="span10">
			...
			if($_FILES['image']['name'] != ""){
					...
					$res = $functions->addRmcProducts($product_name,$product_image,$product_description);
					...
					<form class=""  method="post" enctype="multipart/form-data">
						<fieldset>
							...
							<div class="control-group span12" style="margin-left: 0px; display: flex">
							  ...
							  <input type="text" name="product_name" required="" style="border: 1px solid black;box-shadow: 0px 0px 3px 2px black;">
		...
		<?php
					$result_ar = $functions->get_order_by('rmc_products','id','DESC');
					$i =0;
					...
					<tr>
						...
						<td class="center"><a href="../gallery/rmc-products/<?= $result['product_image'] ?>" target="_blank"><img src="image/rmc-products/<?= $result['product_image'] ?>" style="width: 200px;height:150px"></a></td>
						<td class="center"><?=   htmlspecialchars_decode($result['product_description']);   ?></td>
						<td class="center">
						  
							<a  class="btn btn-primary" href="edit-rmc-products?id=<?php echo $result["id"];?>&action=Edit" title="Delete">
							Edit 
						  </a>
							
							<a onclick="return confirm('Are you sure you would like to Delete Image?');"  class="btn btn-danger" href="rmc-products?id=<?php echo $result["id"];?>&action=Delete" title="Delete">
							Delete 
						  </a>
						</td>
					</tr>	
