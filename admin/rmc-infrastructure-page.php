	...
	<div class="row-fluid">
		...
		<div id="content" class="span10">
            <ul class="breadcrumb">
				...
				<li><a href="#">Rmc Infrastructure Page</a></li>
			</ul>
						<?php 
			...
			if(@$_REQUEST['action']=='remove'){
				$res = $functions->rmcInfrastructureSecondSectionRemoveCotent($id);
				if($res){
			...
			header('Location: rmc-infrastructure-page');
			exit();
				}	
			}
			
			if(@$_REQUEST['action']=='remove1'){
				$res = $functions->rmcInfrastructureThirdSectionRemoveCotent($id);
				if($res){
			...
			if(@$_REQUEST['action']=='remove2'){
				$res = $functions->rmcInfrastructureFourthSectionRemoveCotent($id);
				if($res){
			...
			if(@$_REQUEST['action']=='remove3'){
				$res = $functions->rmcInfrastructureFifthSectionRemoveCotent($id);
				if($res){
			...
			if(@$_REQUEST['action']=='remove4'){
				$res = $functions->rmcInfrastructureSixthSectionRemoveCotent($id);
				if($res){
			...
			$redirect = 'rmc-infrastructure-page';
			...
			if($_FILES['image']['name'] != ""){
					...
					$res = $functions->addInfrastructureFirstSection($below_content,$image);
			...
			if(@$_POST['submit'] == 'Upload'){
				...
				if($_FILES['image']['name'] != ""){
						...
						$res = $functions->addInfrastructureSecondSection($content,$image);
			...
			if(@$_POST['submit'] == 'Upload1'){
				...
				if($_FILES['image']['name'] != ""){
						...
						$res = $functions->addInfrastructureThirdSection($content,$image);
			...
			if(@$_POST['submit'] == 'Upload2'){
				...
				if($_FILES['image']['name'] != ""){
						...
						$res = $functions->addInfrastructureFourthSection($content,$image);
			...
			if(@$_POST['submit'] == 'Upload3'){
				...
				if($_FILES['image']['name'] != ""){
						...
						$res = $functions->addInfrastructureFifthSection($content,$image);
			...
			if(@$_POST['submit'] == 'Upload4'){
				...
				if($_FILES['image']['name'] != ""){
						...
						$res = $functions->addInfrastructureSixthSection($content,$image);
					...
					$res = $functions->get('infrastructure_sections');
			?>
			...
			<div class="row-fluid">		
				<div class="span12">
					...
					<form class=""  method="post" enctype="multipart/form-data">
						<fieldset>
                        	<div class="control-group span12" style="margin-left: 0px;">
							  <label class="control-labe1l" style="margin-bottom: 15px; "><strong>Rmc Infrastructure Banner Section</strong></label>
					...
					<form class=""  method="post" enctype="multipart/form-data">
						<fieldset>
							<div class="control-group span12" style="margin-left: 0px;">
							  <label class="control-labe1l" style="margin-bottom: 15px; "><strong>Rmc Infrastructure Second Section</strong></label>
					...
					<form class=""  method="post" enctype="multipart/form-data">
						<fieldset>
							<div class="control-group span12" style="margin-left: 0px;">
							  <label class="control-labe1l" style="margin-bottom: 15px; "><strong>Rmc Infrastructure Third Section</strong></label>
					...
					<form class=""  method="post" enctype="multipart/form-data">
						<fieldset>
							<div class="control-group span12" style="margin-left: 0px;">
							  <label class="control-labe1l" style="margin-bottom: 15px; "><strong>Rmc Infrastructure Fourth Section</strong></label>
					...
					<form class=""  method="post" enctype="multipart/form-data">
						<fieldset>
							<div class="control-group span12" style="margin-left: 0px;">
							  <label class="control-labe1l" style="margin-bottom: 15px; "><strong>Rmc Infrastructure Fifth Section</strong></label>
					...
					<form class=""  method="post" enctype="multipart/form-data">
						<fieldset>
							<div class="control-group span12" style="margin-left: 0px;">
							  <label class="control-labe1l" style="margin-bottom: 15px; "><strong>Rmc Infrastructure Sixth Section</strong></label>
