	...
	<div class="row-fluid">
		...
		<div id="content" class="span10">
			...
			if(@$_REQUEST['action']=='remove'){
				$res = $functions->rmcCsrSecondSectionRemoveCotent($id);
				if($res){
			...
			header('Location: rmc-csr-page');
			exit();
				}	
			}
			
			if(@$_REQUEST['action']=='remove1'){
				$res = $functions->rmcCsrThirdSectionRemoveCotent($id);
				if($res){
			...
			if(@$_REQUEST['action']=='remove2'){
				$res = $functions->rmcCsrFourthSectionRemoveCotent($id);
				if($res){
			...
			if(@$_REQUEST['action']=='remove3'){
				$res = $functions->rmcCsrFifthSectionRemoveCotent($id);
				if($res){
			...
			if(@$_REQUEST['action']=='remove4'){
				$res = $functions->rmcCsrSixthSectionRemoveCotent($id);
				if($res){
			...
			if($_FILES['image']['name'] != ""){
					...
					$res = $functions->addCsrFirstSection($below_content,$image);
			...
			if(@$_POST['submit'] == 'Upload'){
				...
				if($_FILES['image']['name'] != ""){
						...
						$res = $functions->addCsrSecondSection($content,$image);
			...
			if(@$_POST['submit'] == 'Upload1'){
				...
				if($_FILES['image']['name'] != ""){
						...
						$res = $functions->addCsrThirdSection($content,$image);
			...
			if(@$_POST['submit'] == 'Upload2'){
				...
				if($_FILES['image']['name'] != ""){
						...
						$res = $functions->addCsrFourthSection($content,$image);
			...
			if(@$_POST['submit'] == 'Upload3'){
				...
				if($_FILES['image']['name'] != ""){
						...
						$res = $functions->addCsrFifthSection($content,$image);
			...
			if(@$_POST['submit'] == 'Upload4'){
				...
				if($_FILES['image']['name'] != ""){
						...
						$res = $functions->addCsrSixthSection($content,$image);
					...
					$res = $functions->get('csr_sections');
			?>
			...
			<div class="row-fluid">		
				<div class="span12">
					...
					<form class=""  method="post" enctype="multipart/form-data">
						<fieldset>
                        	<div class="control-group span12" style="margin-left: 0px;">
							  <label class="control-labe1l" style="margin-bottom: 15px; "><strong>Rmc CSR Banner Section</strong></label>
					...
					<form class=""  method="post" enctype="multipart/form-data">
						<fieldset>
							<div class="control-group span12" style="margin-left: 0px;">
							  <label class="control-labe1l" style="margin-bottom: 15px; "><strong>Rmc CSR Second Section</strong></label>
					...
					<form class=""  method="post" enctype="multipart/form-data">
						<fieldset>
							<div class="control-group span12" style="margin-left: 0px;">
							  <label class="control-labe1l" style="margin-bottom: 15px; "><strong>Rmc CSR Third Section</strong></label>
					...
					<form class=""  method="post" enctype="multipart/form-data">
						<fieldset>
							<div class="control-group span12" style="margin-left: 0px;">
							  <label class="control-labe1l" style="margin-bottom: 15px; "><strong>Rmc CSR Fourth Section</strong></label>
					...
					<form class=""  method="post" enctype="multipart/form-data">
						<fieldset>
							<div class="control-group span12" style="margin-left: 0px;">
							  <label class="control-labe1l" style="margin-bottom: 15px; "><strong>Rmc CSR Fifth Section</strong></label>
					...
					<form class=""  method="post" enctype="multipart/form-data">
						<fieldset>
							<div class="control-group span12" style="margin-left: 0px;">
							  <label class="control-labe1l" style="margin-bottom: 15px; "><strong>Rmc CSR Sixth Section</strong></label>
